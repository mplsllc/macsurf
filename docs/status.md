...
**Date:** 2026-07-08
**Engine HEAD:** fixes681 (MacSurf side)
**Current release:** **1.68.1 "macQJS"** — **the JavaScript engine was replaced: Duktape (ES5) → macQJS (QuickJS, ES2023).** Plus the chrome/usability round (bookmarks menu, downloads manager, window maximize, `MacSurfData` folder), working text input (caret / selection / Tab), retained logins, sticky-overlay clicking, the split-scrollbar render fix, downloadable web-font icon glyphs, and a large performance pass (instant startup — removed a ~17 s launch self-test; image/font disk cache; viewport lazy image loading). Full notes: [release-notes/MacSurf-1.68.1.md](release-notes/MacSurf-1.68.1.md). *(The detailed v1.4 narrative below is retained as history.)*
...
**Latest release:** **MacSurf 1.68.1 "macQJS"** (2026-07-08). Full notes: [release-notes/MacSurf-1.68.1.md](release-notes/MacSurf-1.68.1.md). Predecessor: v1.4 "Open House" ([notes](release-notes/MacSurf-1.4.md)), v1.3.1 ([notes](release-notes/MacSurf-1.3.1.md)), v1.3 ([notes](release-notes/MacSurf-1.3.md)).
