...
- `border-radius`, `box-shadow`, opacity, linear and radial gradients; **rgba backgrounds composite against the real backdrop** (2.0.5, #227); `background-clip` box values, longhand `background-origin` (fixes1215/1216, iMac hardware-verified), and `background: none` reset (2.0.5, #255/#268)
...
- **`background-clip: text`** for gradient headings.
