/*
 * MacSurf shim — shims/sys/types.h
 *
 * Forwards to the existing frontends/macos9/sys/types.h shim, which
 * provides off_t/ssize_t/mode_t/time_t via mac_types.h.
 *
 * Reachable via the shims/ search path. Prevents the Linux cross-check
 * from finding glibc's sys/types.h, which pulls in bits/stdint-intn.h
