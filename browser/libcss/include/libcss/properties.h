...
enum css_properties_e {
	...
	CSS_PROP_ROW_GAP			= 0x06a,
	CSS_PROP_COLUMN_RULE_COLOR		= 0x06b,
	CSS_PROP_COLUMN_RULE_STYLE		= 0x06c,
	CSS_PROP_COLUMN_RULE_WIDTH		= 0x06d,
	CSS_PROP_COLUMN_SPAN			= 0x06e,
	CSS_PROP_COLUMN_WIDTH			= 0x06f,
	CSS_PROP_WRITING_MODE			= 0x070,
	CSS_PROP_OVERFLOW_Y			= 0x071,
	CSS_PROP_BOX_SIZING			= 0x072,
	CSS_PROP_ALIGN_CONTENT			= 0x073,
	CSS_PROP_ALIGN_ITEMS			= 0x074,
	CSS_PROP_ALIGN_SELF			= 0x075,
	CSS_PROP_FLEX_BASIS			= 0x076,
	CSS_PROP_FLEX_DIRECTION			= 0x077,
	CSS_PROP_FLEX_GROW			= 0x078,
	CSS_PROP_FLEX_SHRINK			= 0x079,
	CSS_PROP_FLEX_WRAP			= 0x07a,
	CSS_PROP_JUSTIFY_CONTENT		= 0x07b,
	CSS_PROP_ORDER				= 0x07c,
	CSS_PROP_FILL_OPACITY			= 0x07d,
	CSS_PROP_STROKE_OPACITY			= 0x07e,
	CSS_PROP_BORDER_RADIUS			= 0x07f,
	CSS_PROP_BOX_SHADOW			= 0x080,
	CSS_PROP_MACSURF_GRADIENT		= 0x081,
	CSS_PROP_MACSURF_TEXT_SHADOW		= 0x082,
	CSS_PROP_MACSURF_TRANSFORM		= 0x083,
	CSS_PROP_MACSURF_GRID			= 0x084,
	CSS_PROP_MACSURF_ANIMATION_OPACITY	= 0x085,
	CSS_PROP_MACSURF_ANIMATION_ROTATE	= 0x086,
	CSS_PROP_OBJECT_FIT			= 0x087,
	CSS_PROP_MACSURF_OBJECT_POSITION	= 0x088,
	CSS_PROP_TEXT_OVERFLOW			= 0x089,
	CSS_PROP_WORD_BREAK			= 0x08a,
	CSS_PROP_OVERFLOW_WRAP			= 0x08b,
	CSS_PROP_MACSURF_GRID_ROWS		= 0x08c,
	CSS_PROP_MACSURF_GRID_COL_SPAN		= 0x08d,
	CSS_PROP_ASPECT_RATIO			= 0x08e,
	CSS_PROP_BACKGROUND_SIZE                = 0x08f,
	CSS_PROP_POINTER_EVENTS                 = 0x090,
	CSS_PROP_MACSURF_GRID_FLOW              = 0x091,
	CSS_PROP_ACCENT_COLOR                   = 0x092,
	CSS_PROP_CARET_COLOR                    = 0x093,
	CSS_PROP_BOX_DECORATION_BREAK           = 0x094,
	CSS_PROP_TAB_SIZE                       = 0x095,
	CSS_PROP_IMAGE_RENDERING                = 0x096,
	CSS_PROP_TEXT_DECORATION_COLOR          = 0x097,
	CSS_PROP_TEXT_DECORATION_STYLE          = 0x098,
	CSS_PROP_TEXT_DECORATION_THICKNESS      = 0x099,
	CSS_PROP_MACSURF_HSTRIPE_BG             = 0x09a,
	CSS_PROP_MACSURF_DOTGRID                = 0x09b,
	CSS_PROP_TEXT_ALIGN_LAST                = 0x09c,
	CSS_PROP_HYPHENS                        = 0x09d,
	CSS_PROP_TEXT_JUSTIFY                   = 0x09e,
	CSS_PROP_HANGING_PUNCTUATION            = 0x09f,
...
enum css_macsurf_text_shadow_e {
...
enum css_macsurf_object_position_e {
	CSS_MACSURF_OBJECT_POSITION_INHERIT	= 0x0,
	CSS_MACSURF_OBJECT_POSITION_START	= 0x1,
	CSS_MACSURF_OBJECT_POSITION_CENTER	= 0x2,
	CSS_MACSURF_OBJECT_POSITION_END		= 0x3
};
...
enum css_overflow_wrap_e {
	CSS_OVERFLOW_WRAP_INHERIT		= 0x0,
	CSS_OVERFLOW_WRAP_NORMAL		= 0x1,
	CSS_OVERFLOW_WRAP_BREAK_WORD		= 0x2,
	CSS_OVERFLOW_WRAP_ANYWHERE		= 0x3
};
...
/* Shared "which intrinsic-sizing keyword" selector for width/min-width/
 * max-width's CSS_*_INTRINSIC type value (fixes: intrinsic-sizing round 1).
 * Stored in the otherwise-unused unit sub-field of each property's packed
 * bits[] slot when type == *_INTRINSIC (that sub-field only carries a
 * css_unit when type == *_SET) -- see set_width/get_width in
 * autogenerated_propset.h/autogenerated_propget.h. Deliberately NOT part of
 * the global css_unit enum: css_unit is shared across unrelated properties
 * and only has 2 free codes left (0x13/0x14), not enough for 3 keywords. */
enum css_intrinsic_kind_e {
	CSS_INTRINSIC_MIN_CONTENT		= 0x0,
	CSS_INTRINSIC_MAX_CONTENT		= 0x1,
	CSS_INTRINSIC_FIT_CONTENT		= 0x2
};
