...
const stringmap_entry stringmap[LAST_KNOWN] = {
	...
	/* #247: CSS logical property names (aliased to physical longhands in
	 * parseProperty). Order MUST match the enum in propstrings.h. */
	SMAP("margin-block-start"),
	SMAP("margin-block-end"),
	SMAP("margin-inline-start"),
	SMAP("margin-inline-end"),
	SMAP("padding-block-start"),
	SMAP("padding-block-end"),
	SMAP("padding-inline-start"),
	SMAP("padding-inline-end"),
	SMAP("inset-block-start"),
	SMAP("inset-block-end"),
	SMAP("inset-inline-start"),
	SMAP("inset-inline-end"),
	SMAP("block-size"),
	SMAP("inline-size"),
	SMAP("min-block-size"),
	SMAP("min-inline-size"),
	SMAP("max-block-size"),
	SMAP("max-inline-size"),
	SMAP("inherit"),
	SMAP("unset"),
	SMAP("important"),
	SMAP("none"),
