...
enum {
	...
	QUOTES, RICHNESS, RIGHT, ROW_GAP, SPEAK_HEADER, SPEAK_NUMERAL, SPEAK_PUNCTUATION,
	...
	MACSURF_ANIMATION_ROTATE, OBJECT_FIT, MACSURF_OBJECT_POSITION,
	TEXT_OVERFLOW,
	WORD_BREAK, OVERFLOW_WRAP, WORD_WRAP,
	MACSURF_GRID_ROWS,
	MACSURF_GRID_COL_SPAN,
	ASPECT_RATIO,
	BACKGROUND_SIZE,
	POINTER_EVENTS,
	MACSURF_GRID_FLOW,
	...
	VERTICAL_RL, VERTICAL_LR, CONTENT_BOX, BORDER_BOX, PADDING_BOX, STRETCH, INLINE_FLEX,
	...
	INFINITE, GRID, INLINE_GRID, CONTENTS, STICKY, CALC,
	MIN, MAX, CLAMP,
	LINEAR_GRADIENT, RADIAL_GRADIENT,
	REPEATING_LINEAR_GRADIENT, REPEATING_RADIAL_GRADIENT,
	TO,
	CONTAIN, COVER, FILL, SCALE_DOWN, ELLIPSIS,
	BREAK_ALL, KEEP_ALL, BREAK_WORD, ANYWHERE,
	SLICE, CLONE,
	SMOOTH, HIGH_QUALITY, CRISP_EDGES, PIXELATED,
	WAVY, FROM_FONT,
	MARKER, PLACEHOLDER, FILE_SELECTOR_BUTTON,
	IS_FN, WHERE_FN, HAS_FN,
	START, END,
	MANUAL, INTER_WORD, INTER_CHARACTER, LAST, FORCE_END, ALLOW_END,
