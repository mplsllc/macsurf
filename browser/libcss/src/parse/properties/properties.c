...
const css_prop_handler property_handlers[LAST_PROP + 1 - FIRST_PROP] =
{
	...
	css__parse_macsurf_object_position,
	...
	css__parse_text_decoration_color,
...
const uint32_t property_unit_mask[CSS_N_PROPERTIES] = {
	...
	[CSS_PROP_MACSURF_OBJECT_POSITION] = 0,
	...
	[CSS_PROP_ROW_GAP]               = UNIT_MASK_COLUMN_GAP,
