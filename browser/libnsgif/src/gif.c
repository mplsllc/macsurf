		...
		nsgif_bitmap_fmt_t bitmap_fmt)
{
	 ...
	 * Struct field order: r, g, b, a.
	 * CW8 C89: no compound literals or designated initializers. */
	{
		struct nsgif_colour_layout layout;
		switch (bitmap_fmt) {
		default:
		...
		case NSGIF_BITMAP_FMT_B8G8R8A8:
			layout.r = 2; layout.g = 1; layout.b = 0; layout.a = 3;
			break;
		case NSGIF_BITMAP_FMT_A8R8G8B8:
			layout.r = 1; layout.g = 2; layout.b = 3; layout.a = 0;
			break;
		case NSGIF_BITMAP_FMT_A8B8G8R8:
			layout.r = 3; layout.g = 2; layout.b = 1; layout.a = 0;
			break;
		}
		return layout;
	}
